...
export function ProductGrid() {
  ...
  if (!isConnected) {
    return (
      <div className="text-center py-20" role="alert" aria-live="polite">
        <div className="max-w-md mx-auto">
          <div className="glass-card p-12 rounded-2xl border border-purple-500/20 neon-box relative overflow-hidden">
            ...
            <div className="relative z-10">
              <div className="w-16 h-16 md:w-20 md:h-20 border-4 border-purple-500/30 rounded-full mx-auto flex items-center justify-center mb-8 bg-purple-500/10">
                <svg 
              ...
              <div className="flex justify-center space-x-4 text-sm text-white/80">
                <div className="flex items-center">
                  <svg className="w-3.5 h-3.5 mr-2 text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
      ...
      <div className="text-center py-20" role="status" aria-live="polite">
        <div className="max-w-md mx-auto">
          <div className="relative">
            ...
            <p className="text-white/80">Buscando os melhores tokens para você</p>
      ...
      <div className="text-center py-20" role="alert" aria-live="assertive">
        <div className="max-w-lg mx-auto">
          <div className="glass-card p-12 rounded-2xl border border-red-500/30 relative overflow-hidden">
            ...
            <div className="relative z-10">
              <div className="w-16 h-16 md:w-20 md:h-20 mx-auto mb-8 rounded-full bg-red-500/20 flex items-center justify-center border-4 border-red-500/30">
                <svg 
                  xmlns="http://www.w3.org/2000/svg" 
                  fill="none" 
                  viewBox="0 0 24 24" 
              ...
              <p className="text-white/90 mb-8 leading-relaxed">{error.message}</p>
              
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <button 
                  onClick={() => window.location.reload()}
                  className="bg-red-600 hover:bg-red-700 text-white px-6 py-3 rounded-lg font-medium transition-all duration-300 flex items-center justify-center focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 focus:ring-offset-black"
                ...
                <button 
                  className="bg-white/10 hover:bg-white/20 text-white px-6 py-3 rounded-lg font-medium transition-all duration-300 border border-white/20 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-black"
  ...
  return (
    <section aria-labelledby="products-section-title">
      ...
      <div className="text-center mb-16">
        ...
        <h2 id="products-section-title" className="text-4xl md:text-5xl font-bold mb-6 font-heading text-white neon-text">
        ...
        {/* Filter/Sort Bar */}
        <nav aria-label="Filtros de produtos" className="flex flex-wrap justify-center gap-4 mb-12">
          <button className="glass-card px-6 py-3 rounded-full text-white hover:bg-purple-500/20 transition-all duration-300 border border-purple-500/30 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:ring-offset-black" aria-current="page">
          ...
          <button className="glass-card px-6 py-3 rounded-full text-white/80 hover:text-white hover:bg-purple-500/20 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:ring-offset-black">
            Trending
          </button>
          <button className="glass-card px-6 py-3 rounded-full text-white/80 hover:text-white hover:bg-purple-500/20 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:ring-offset-black">
            Novos
      ...
      {/* Products Grid */}
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16" role="grid" aria-label="Grade de produtos">
      ...
      <div className="text-center">
        <button 
          className="glass-card px-8 py-4 rounded-xl text-white hover:bg-purple-500/20 transition-all duration-300 border border-purple-500/30 hover:border-purple-500/50 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:ring-offset-black"
          aria-label="Carregar mais produtos da lista"
        >
          <span className="flex items-center">
