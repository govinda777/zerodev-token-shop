  ...
  return (
    <div className="flex flex-col min-h-screen gradient-background">
      ...
      <main className="flex-grow w-full">
        ...
        <section className="relative py-20 px-4 sm:px-6 lg:px-8" aria-labelledby="hero-title">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <h1 id="hero-title" className="text-6xl md:text-7xl lg:text-8xl font-bold mb-6 font-heading text-white neon-text leading-tight">
                ZeroDev
              ...
              {/* Stats Section */}
              <section aria-labelledby="stats-title" className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto mb-12">
                <h2 id="stats-title" className="sr-only">Estatísticas da plataforma</h2>
                <div className="glass-card p-6 text-center">
                  <div className="text-3xl font-bold text-purple-400 mb-2">500+</div>
                  <div className="text-white/80 text-sm">Tokens Únicos</div>
                </div>
                <div className="glass-card p-6 text-center">
                  <div className="text-3xl font-bold text-purple-400 mb-2">24/7</div>
                  <div className="text-white/80 text-sm">Disponível</div>
                </div>
                <div className="glass-card p-6 text-center">
              ...
              {/* Features */}
              <section aria-labelledby="features-title" className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto mb-16">
                <h2 id="features-title" className="sr-only">Características da plataforma</h2>
                <article className="glass-card p-8 text-center group hover:scale-105 transition-all duration-300">
                  ...
                  <p className="text-white/80">Transações protegidas por smart contracts auditados</p>
                </article>
                ...
                <article className="glass-card p-8 text-center group hover:scale-105 transition-all duration-300">
                  ...
                  <p className="text-white/80">Transações instantâneas com baixas taxas de gas</p>
                </article>
                ...
                <article className="glass-card p-8 text-center group hover:scale-105 transition-all duration-300">
                  ...
                  <p className="text-white/80">Todos os tokens são verificados e autenticados</p>
                </article>
              </section>
            </div>
          </div>
        ...
        {/* Products Section */}
        <section className="py-16 px-4 sm:px-6 lg:px-8" aria-labelledby="products-title">
          <div className="max-w-6xl mx-auto">
